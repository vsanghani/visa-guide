...
export default function Footer() {
  return (
    <footer className="relative z-10 mt-20 bg-surface-container-low">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-primary-container flex items-center justify-center shadow-[var(--shadow-ambient)]">
            ...
            <p className="text-primary/65 text-sm leading-relaxed mb-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-secondary text-sm hover:text-primary transition-colors"
            >
          ...
          {footerSections.map((section) => (
            <div key={section.title}>
              <h3 className="text-primary font-semibold text-sm mb-4 tracking-wide uppercase opacity-90">
                {section.title}
              </h3>
                  ...
                  <li key={link.label}>
                    {"external" in link && link.external ? (
                      <a
                        ...
                        className="text-primary/65 text-sm hover:text-secondary transition-colors inline-flex items-center gap-1.5"
                      >
                        {link.label}
                      ...
                      <Link
                        href={link.href}
                        className="text-primary/65 text-sm hover:text-secondary transition-colors"
                      >
                        {link.label}
                      </Link>
                    )}
        ...
        <div className="mt-16 pt-10">
          <p className="text-primary/50 text-xs leading-relaxed mb-4">
            <strong className="text-primary/70">Disclaimer:</strong> This website provides general
